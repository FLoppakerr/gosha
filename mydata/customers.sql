...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 23, 2024 at 11:45 AM
...
INSERT INTO `customers_data` (`id`, `business_type`, `business_name`, `company_name`, `contact_name`, `email`, `phone`, `line_id`, `facebook`, `province`, `amphure`, `district`, `zip_code`) VALUES
(1, 'test_type', 'test_business', 'test_company', 'test_contact', 'test_01@gmail.com', '089 876 5432', 'test_LineID', 'test_facebook', '7', '107', '161105', 15170);
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci COMMENT='InnoDB free: 8192 kB';
...
('100205', 10800, 'บางซื่อ', 'Bang Sue', 2),
('100206', 10300, 'ถนนนครไชยศรี', 'Thanon Nakhon Chai Si', 2),
('100299', 10400, 'สามเสนใน', 'Sam Sen Nai', 2),
...
INSERT INTO `users` (`id`, `username`, `password`, `profile_image`, `user_role`) VALUES
(1, 'KingFlop', 'KingFlop101', 'uploads/3700cd18411ca9079ed0bd19dceebce2.jpg', 'admin'),
(2, 'Guest', 'Guest', '', 'Guest');
...
ALTER TABLE `customers_data`
  ...
  ADD UNIQUE KEY `amphure` (`amphure`),
